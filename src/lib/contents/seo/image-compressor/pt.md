## Como comprimir imagem sem perder qualidade demais

Comprimir imagem não significa deixar o arquivo no menor tamanho possível a qualquer custo. O ideal é reduzir o peso da imagem mantendo qualidade suficiente para o uso final: site, e-mail, formulário, documento, loja virtual, rede social ou material de trabalho.
...
|---|---|---|
| Site ou blog | Qualidade média a alta, reduzir largura se a imagem for muito grande | A imagem deve carregar leve e continuar nítida no computador e no celular. |
| Foto de produto | Qualidade alta, compressão moderada | Confira cor, textura, bordas e detalhes do produto. |
| Anexo de e-mail | Qualidade média, ajustar largura quando necessário | O arquivo deve ficar fácil de enviar e claro para quem recebe. |
| Formulário ou documento | Comprimir primeiro, reduzir dimensões se ainda estiver pesado | Texto, números, documento e bordas precisam continuar legíveis. |
| Redes sociais | Qualidade média a alta | Algumas plataformas comprimem a imagem novamente, então evite exagerar. |
| Captura de tela | Qualidade mais alta, compressão leve | Verifique se textos, tabelas, ícones e linhas finas continuam claros. |
...
PNG é mais comum em logos, ícones, capturas de tela, imagens com texto, elementos de interface e arquivos com fundo transparente. Nesse caso, é importante preservar bordas, letras e transparência. Para esse tipo de arquivo, use o [compressor PNG](/pt/png-compressor).
...
Imagens grandes podem deixar páginas mais pesadas, principalmente no celular. Antes de publicar fotos em blogs, landing pages, portfólios, lojas virtuais ou páginas institucionais, vale compactar os arquivos para reduzir o tempo de carregamento.

Um fluxo simples é:

1. Verificar o tamanho em que a imagem será exibida.
2. Reduzir a largura se o arquivo original for grande demais.
3. Comprimir a imagem com qualidade equilibrada.
4. Conferir o resultado no computador e no celular.
5. Guardar o arquivo original caso precise editar depois.
...
- [Comprimir JPG online](/pt/jpg-compressor): para fotos, imagens de produto e arquivos JPG/JPEG
- [Comprimir PNG online](/pt/png-compressor): para PNG, logos, ícones, capturas de tela e imagens com transparência
- [Reduzir tamanho da imagem](/pt/reduce-image-size): para arquivos que precisam caber em limites de upload, e-mail, formulários e documentos
