<script lang="ts">
	...
	let copy: PageCopy = $derived({
		metaTitle:        t('cc.meta.title'),
		metaDesc:         t('cc.meta.desc'),
		heroTitle:        t('cc.hero.title'),
		heroSub:          t('cc.hero.sub'),
		pill1:            t('cc.pill.realtime'),
		pill2:            t('cc.pill.noUpload'),
		pill3:            t('cc.pill.free'),
		// Tool UI
